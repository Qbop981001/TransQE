        ...
        for batch in train_loader:
            ...
            if cur_step % 1000 == 0:
                ...
                if f1 > best_f1:
                    ...
                    torch.save(model.state_dict(), os.path.join(ckpt_dir, f"ft-bert-zh_enzh.pth"))
...
def predict(valid_loader):
    ...
    model.to(device)
    model.load_state_dict(torch.load(os.path.join(ckpt_dir, f"ft-bert-zh_enzh.pth")))
    out = evaluate(model, valid_loader, device)
    p = out[0]
    r = out[1]
    f1 = out[2]
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'train':
        train_loader = build_dataloader('test18')
        ...
        for i in range(17,21):
            ...
            print(f"Normal translation in test{i} : {p},{r},{f1}\n=============end============")
